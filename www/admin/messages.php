    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto " href="admin.php">Go back</a></li>
        </ul>
            ...
            <div class="row">
                <div class="col">
                    <div class="mt-6 mb-5 clearfix">
                        <h2 class="pull-left">Messagess</h2>
                    </div>
                    <?php
                    // Include config file
                    ...
                    if($result = mysqli_query($con, $sql)){
                        if(mysqli_num_rows($result) > 0){
                                ...
                                while($row = mysqli_fetch_array($result)){
                                        echo "<b>Name:</b><br>" . $row['name']."<br><br>";
                                        echo "<b>Email:</b><br>" . $row['email']."<br><br>";
                                        echo "<b>Subject:</b><br>" . $row['subject'] ."<br><br>";
                                        echo "<b>Message:</b><br>" . $row['message'] ."<br><br>";
                                        echo"<hr>";
